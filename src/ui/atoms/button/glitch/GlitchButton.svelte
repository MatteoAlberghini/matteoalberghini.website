...
<script lang="ts">
  /* import */
	import { MapTypeToPrimaryColor, MapTypeToSecondaryColor, type AtomType } from "../../../../types/structure/atoms.types"
  import type { Color } from "../../../../types/common/colors.types"

  /* props */
  export let marginLeft: string = '0px' 
